...
|---------|---------|---------------------|
| `historico_atendimento.csv` | CSV | Contextualizar interações anteriores ou seja, dar continuidade no atendimento de formais eficiente.. |
...
Últimas transações (transações.csv)
